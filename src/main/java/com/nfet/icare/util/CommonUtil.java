...
import com.nfet.icare.pojo.Token;
import com.nfet.icare.pojo.WechatUserInfo;
...
public class CommonUtil {
    ...
    /**
     * @Title: getToken   
     * @Description: 根据appid和appsecret获取接口访问凭证 
     * @param appid 凭证
     * @param appsecret 密钥
     * @return
     */
    ...
    /**
     * @Title: getUserInfo   
     * @Description: 根据access_token和openid获取微信用户信息 
     * @param accessToken
     * @param openId 每个用户对每个公众号的唯一标识值
     * @return
     */
